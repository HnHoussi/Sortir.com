 ...
 */
final class Version20250831223623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sortie (id INT AUTO_INCREMENT NOT NULL, place_id INT NOT NULL, status_id INT NOT NULL, organizer_id INT NOT NULL, name VARCHAR(30) NOT NULL, start_datetime DATETIME NOT NULL, duration INT NOT NULL, registration_deadline DATETIME DEFAULT NULL, max_registrations INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, photo_url VARCHAR(255) DEFAULT NULL, cancellation_reason VARCHAR(255) DEFAULT NULL, INDEX IDX_3C3FD3F2DA6A219 (place_id), INDEX IDX_3C3FD3F26BF700BD (status_id), INDEX IDX_3C3FD3F2876C4DDA (organizer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
